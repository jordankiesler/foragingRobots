...
class LightSource(Stimulus):
    ...
    def pygame_draw(self, screen, scale, shiftx, shifty):
        pygame.draw.circle(screen, center=(scale * self.x + shiftx, scale * self.y + shifty), color='yellow',
                           radius=scale * 0.7)
        pygame.draw.circle(screen, center=(scale * self.x + shiftx, scale * self.y + shifty), color='orange',
                           radius=scale * 0.2)
